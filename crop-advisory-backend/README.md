# Crop Advisory Backend — Setup & Testing Instructions

This is the complete backend for the Voice-First Crop Advisory project.
Everything is already written — follow the steps below to save it, run it,
